...
```
Task(
  prompt="Read C:/Users/lamonta/Code/grimoire/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/lamonta/Code/grimoire/.claude/get-shit-done/templates/SECURITY.md`
