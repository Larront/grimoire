...
```bash
INIT=$(node "C:/Users/lamonta/Code/grimoire/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @C:/Users/lamonta/Code/grimoire/.claude/get-shit-done/templates/spec.md.
