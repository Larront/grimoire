...
> **Superseded by [ADR-0006](./0006-pane-local-detail-surface.md) (2026-05-29).** The
> notes-only scope held through Phases 5–9; ADR-0006 opens the "extend later" door this ADR
> left ajar, unifying the note rail and the floating map panels behind one pane-local
> `DetailPanel`. The reasoning below is retained as the record of why the scope was bounded
> at the time.
