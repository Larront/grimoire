...
- Editing the sample and then restarting _without_ adopting loses the changes. This is intended — no commitment was made, and _Make this world mine_ is the documented path to persist work.
...
- New backend surface is minimal: an ephemeral sample-open path plus one "copy a directory tree to a chosen destination" primitive (shared by _Explore_'s reset-copy and _Make this world mine_).
